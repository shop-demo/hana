    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card-body w-50 mx-auto">
            <h5 class="card-title text-uppercase text-center fs-4" >Thêm khách hàng</h5>
               @if($errors->any())
            ...
            <form class="row g-4" action="{{route('admin.customeAdd_Post')}}" method="POST" >
              ...
              <div class="col-12">
                ...
                <input type="text" class="form-control" id="inputNanme4" value="{{old('name')}}" name="name" placeholder="Nhập name" >
                @error('name')
              ...
              <div class="col-12">
                ...
                <input type="email" class="form-control" id="inputEmail4" value="{{old('email')}}" name="email" placeholder="Nhập email">
                @error('email')
                    <span class="text-danger">{{$message}}</span>
                @enderror
              </div>
              <div class="col-12">
                ...
                <input type="password" class="form-control" id="inputPassword4" value="{{old('password')}}" name="password" placeholder="Nhập password">
              @error('password')
                    <span class="text-danger">{{$message}}</span>
                @enderror
              </div>
